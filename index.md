...
- The results of the first mock test will be out tomorrow. Scorecard will be available [here](docs/mock_test/017_mar_17_scorecard). What is
currenly available is only a partial scorecard.
