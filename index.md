...
<button class="button numbers" onclick="location.href='/docs/geometry/number_theory/gcd/#magic-number';" onmouseover = "display('A3_2015')"></button>
...
<button class="button numbers" onclick="location.href='/docs/geometry/number_theory/gcd/#euclidean-algorithm';" onmouseover = "display('B5_2015')"></button>
...
<button class="button numbers" onclick="location.href='/docs/geometry/number_theory/gcd/#totient-function';" onmouseover = "display('A3_2016')"></button>
...
<button class="button numbers" onclick="location.href='/docs/geometry/number_theory/gcd/#gcd-application';" onmouseover = "display('A7_2016')"></button>
...
<button class="button numbers" onclick="location.href='/docs/geometry/number_theory/gcd/#sample-a-divisor';" onmouseover = "display('A4_2017')"></button>
...
<button class="button numbers" onclick="location.href='/docs/geometry/number_theory/gcd/#carrom-board-math';" onmouseover = "display('B6_2018')"></button>
<button class="button blank" onmouseover = "display('none')"></button>
<button class="button blank" onmouseover = "display('none')"></button>
<button class="button blank" onmouseover = "display('none')"></button>
<button class="button blank" onmouseover = "display('none')"></button>
